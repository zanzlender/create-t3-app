...
<Quote
  text="Build safety nets, not guard rails"
  author={{
    name: "Theo - creator of the T3 Stack",
    handle: "t3dotgg",
    avatar: "https://github.com/t3dotgg.png",
    link: "https://twitter.com/t3dotgg",
  }}
/>
...
<Iframe
  src="https://www.youtube.com/embed/RmGHnYUqQ4k"
  title="You might be using Typescript wrong"
/>
